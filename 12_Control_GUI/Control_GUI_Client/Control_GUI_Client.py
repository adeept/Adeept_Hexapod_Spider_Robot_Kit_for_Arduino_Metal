...
def call_steady(event):
	...
	if(stat_steady == 0):
		...
		stat_steady = 0
		print("Steady Off")
		tcpClicSock.send(('steadyOff').encode())
...
def call_police(event):
	print("ws2812 LED police")
	tcpClicSock.send(('{"lightMode":"police","data":[255,0,0]}').encode())
...
def loop():					  #GUI
	...
	while True:
		...
		Btn_Ultra = tk.Button(root, width=8, text='RadarScan',fg=color_text,bg=color_btn,relief='ridge')
		...
		Btn_Police.place(x=284,y=265)
		Btn_Police.bind('<ButtonPress-1>', call_police)
		root.bind('<KeyPress-p>', call_police)

		Btn_LookLeft = tk.Button(root, width=8, text='LookLeft',fg=color_text,bg=color_btn,relief='ridge')
		Btn_LookLeft.place(x=30,y=265)
		Btn_LookLeft.bind('<ButtonPress-1>', call_lookleft)
		root.bind('<KeyPress-j>', call_lookleft)
		Btn_LookLeft.bind('<ButtonRelease-1>', call_LRStop)
		root.bind('<KeyRelease-j>', call_LRStop)

		Btn_LookRight = tk.Button(root, width=8, text='LookRight',fg=color_text,bg=color_btn,relief='ridge')
		Btn_LookRight.place(x=170,y=265)
		Btn_LookRight.bind('<ButtonPress-1>', call_lookright)
		root.bind('<KeyPress-l>', call_lookright)
		Btn_LookRight.bind('<ButtonRelease-1>', call_LRStop)
		...
		Btn_RightSide = tk.Button(root, width=8, text='Keep',fg=color_text,bg=color_btn,relief='ridge')
		Btn_RightSide.place(x=170,y=195)
		Btn_RightSide.bind('<ButtonPress-1>', call_keep)
		...
		Btn0.bind('<ButtonRelease-1>', call_DTS)
		Btn1.bind('<ButtonRelease-1>', call_DTS)
		Btn2.bind('<ButtonRelease-1>', call_DTS)
		Btn3.bind('<ButtonRelease-1>', call_DTS)
		...
		root.bind('<KeyPress-e>', call_keep)

		root.bind('<KeyRelease-w>', call_DTS)
		root.bind('<KeyRelease-a>', call_DTS)
		root.bind('<KeyRelease-d>', call_DTS)
		root.bind('<KeyRelease-s>', call_DTS)
